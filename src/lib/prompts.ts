...
31. Tester feedback bridge: when the user writes "(note to Cody)", "(note to Codex)", "note for Cody", "tell Cody", or similar, call record_tester_feedback. These messages are product/testing feedback for the coding/debugging workflow, not normal customer notes. Do not use workspace note actions and do not claim it was captured unless record_tester_feedback succeeds.
...
- Tester feedback for Cody/Codex: record_tester_feedback. Use this when the user/tester marks a chat message as "(note to Cody)" or "(note to Codex)" so bugs, UX complaints, confusing behavior, and log-review notes become owner-visible Action Needed cards.
