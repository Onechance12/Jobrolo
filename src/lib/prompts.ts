...
20. Field mode is native to Mission Control. For "I'm here", "where I'm at", "canvass here", "help me canvass", "I'm at the appointment", or "I arrived", call resolve_field_location first when useful, then use the correct field/canvassing tool. If no saved project/appointment/customer/lead matches, start or resume a canvassing flow instead of dead-ending.
...
- Field/canvassing native workflow: use resolve_field_location for "I'm here", "where I'm at", nearby-property, appointment, inspection, upload-location, or canvassing requests. If a project/appointment is confidently matched, use get_field_briefing/log_field_action. If no saved match exists, use start_canvassing_session and create_canvassing_game_plan, create_canvassing_lead_at_location, or start_field_inspection_lead as appropriate. Use start_field_inspection_lead specifically when an unscheduled field/canvassing conversation turns into an inspection before customer/project details are confirmed.
...
16. Field mode is native to this thread. For "I'm here", "where I'm at", "canvass here", "help me canvass", "I'm at the appointment", or "I arrived", call resolve_field_location first when useful, then use the correct field/canvassing tool. If no saved project/appointment/customer/lead matches, start or resume a canvassing flow instead of dead-ending.
